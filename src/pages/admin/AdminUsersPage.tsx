  ...
  return (
    <>
      <PageHeader
        ...
        title={
          <>
            Users & <GradientText>roles.</GradientText>
          </>
        }
        description="Review account status, platform roles, verification, and administrative actions."
      />
        ...
        >
          <div className={s.tableWrap}>
            <table className={s.table}>
              ...
              <tbody>
                {users.map(([id, name, role, verification, status]) => (
                  <tr key={id}>
                    <td>{id}</td>
                    <td>{name}</td>
                    <td>{role}</td>
