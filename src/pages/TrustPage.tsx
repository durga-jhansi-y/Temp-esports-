  ...
  return (
    <div style={{ backgroundColor: '#0A0A0B', color: 'white', padding: '60px 20px' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '20px', textAlign: 'left', flexWrap: 'wrap', marginBottom: '60px' }}>
          <div style={{ flex: '1 1 300px', padding: '24px', backgroundColor: '#111115', borderRadius: '8px', border: '1px solid #27272A' }}>
            <div style={{ fontSize: '2rem', color: '#27272A', fontWeight: '900', marginBottom: '12px' }}>01</div>
            <h4 style={{ fontSize: '1.1rem', margin: '0 0 8px 0' }}>Claim your name</h4>
            <p style={{ color: '#A1A1AA', fontSize: '0.9rem', margin: 0, lineHeight: '1.5' }}>Pick your subdomain with a live availability check</p>
          </div>
          <div style={{ flex: '1 1 300px', padding: '24px', backgroundColor: '#111115', borderRadius: '8px', border: '1px solid #27272A' }}>
            <div style={{ fontSize: '2rem', color: '#27272A', fontWeight: '900', marginBottom: '12px' }}>02</div>
            <h4 style={{ fontSize: '1.1rem', margin: '0 0 8px 0' }}>Brand it</h4>
            <p style={{ color: '#A1A1AA', fontSize: '0.9rem', margin: 0, lineHeight: '1.5' }}>Drop in your logo, pick your colors-it's instantly yours.</p>
          </div>
          <div style={{ flex: '1 1 300px', padding: '24px', backgroundColor: '#111115', borderRadius: '8px', border: '1px solid #27272A' }}>
            <div style={{ fontSize: '2rem', color: '#27272A', fontWeight: '900', marginBottom: '12px' }}>03</div>
            <h4 style={{ fontSize: '1.1rem', margin: '0 0 8px 0' }}>Go live & get paid</h4>
            <p style={{ color: '#A1A1AA', fontSize: '0.9rem', margin: 0, lineHeight: '1.5' }}>Players register, you run brackets, PayPal handles payouts</p>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '20px', textAlign: 'left', flexWrap: 'wrap' }}>
          <div style={{ flex: '1 1 300px', padding: '24px', backgroundColor: '#111115', borderRadius: '8px', border: '1px solid #1c1c21' }}>
            <h4 style={{ fontSize: '1.1rem', margin: '0 0 8px 0', color: '#7a5cff' }}>Run brackets on autopilot</h4>
            <p style={{ color: '#A1A1AA', fontSize: '0.9rem', margin: 0, lineHeight: '1.5' }}>Single/double elimination, round-robin, Swiss seeded, auto advancing, with check-in and dispute handling</p>
          </div>
          <div style={{ flex: '1 1 300px', padding: '24px', backgroundColor: '#111115', borderRadius: '8px', border: '1px solid #1c1c21' }}>
            <h4 style={{ fontSize: '1.1rem', margin: '0 0 8px 0', color: '#7a5cff' }}>Get paid automatically</h4>
            <p style={{ color: '#A1A1AA', fontSize: '0.9rem', margin: 0, lineHeight: '1.5' }}>PayPal entry fees in prize payouts out-server verified</p>
          </div>
          <div style={{ flex: '1 1 300px', padding: '24px', backgroundColor: '#111115', borderRadius: '8px', border: '1px solid #1c1c21' }}>
            <h4 style={{ fontSize: '1.1rem', margin: '0 0 8px 0', color: '#7a5cff' }}>Look like a $1M brand</h4>
            <p style={{ color: '#A1A1AA', fontSize: '0.9rem', margin: 0, lineHeight: '1.5' }}>Your subdomain, logo, and colors across the whole experience</p>
          </div>
        </div>
